...
const modulos = [
  {
    ...
    items: [
      ...
      { title: "Reportes", href: "/ventas/reportes" },
    ],
  },
  {
    title: "Compras",
    items: [
      ...
      { title: "Devoluciones", href: "/compras/notas-de-devolucion" },
      { title: "Notas de crédito", href: "/compras/notas-de-credito" },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Conceptos salariales", href: "/personas/conceptos-salariales" },
      {
        ...
        href: "/personas/parametros-salariales",
      },
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Reportes contables", href: "/contabilidad/reportes" },
    ],
  },
];
