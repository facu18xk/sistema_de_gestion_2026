...
namespace api.Migrations.DblosAmigos
{
    ...
    [Migration("20260522194613_UsePresupuestoForFacturasVentas")]
    partial class UsePresupuestoForFacturasVentas
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("api.Models.Asiento", b =>
                {
                    ...
                    b.Property<DateTime?>("FechaMayorizacion")
                        .HasColumnType("timestamp without time zone")
                    ...
                    b.Property<int>("IdPeriodoContable")
                        .HasColumnType("integer")
                        .HasColumnName("periodo_contable_id");
                    ...
                    b.HasIndex("IdPeriodoContable");

                    b.ToTable("asientos", (string)null);
                });

            modelBuilder.Entity("api.Models.AsientosDetalle", b =>
                {
                    ...
                    b.ToTable("asientos_detalles", (string)null);
                });
            ...
            modelBuilder.Entity("api.Models.Balance", b =>
                {
                    ...
                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("IdBalance"));
            ...
            modelBuilder.Entity("api.Models.BalancesDetalle", b =>
                {
                    b.Property<int>("IdBalanceDetalle")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasColumnName("id");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("IdBalanceDetalle"));
                    ...
                    b.Property<decimal>("SaldoAcreedor")
                        .HasColumnType("decimal(18, 2)")
            ...
            modelBuilder.Entity("api.Models.CategoriaProveedor", b =>
                {
            ...
            modelBuilder.Entity("api.Models.CuentaContable", b =>
                {
                    ...
                    b.Property<bool>("EsAsentable")
                        .HasColumnType("boolean")
                        .HasColumnName("es_asentable");

                    b.Property<int?>("IdCuentaPadre")
                        .HasColumnType("integer")
                        .HasColumnName("cuenta_padre_id");

                    b.Property<int>("IdProcesoContable")
                        .HasColumnType("integer")
                        .HasColumnName("proceso_contable_id");
            ...
            modelBuilder.Entity("api.Models.ModeloAsiento", b =>
                {
                    b.Property<int>("IdModeloAsiento")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasColumnName("id");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("IdModeloAsiento"));
                    ...
                    b.Property<string>("DetalleResumen")
                        .HasMaxLength(200)
                        .IsUnicode(false)
                        .HasColumnType("character varying(200)")
                    ...
                    b.HasKey("IdModeloAsiento");

                    b.HasIndex("IdModulo");

                    b.ToTable("modelos_asientos", (string)null);
                });

            modelBuilder.Entity("api.Models.ModelosAsientosDetalle", b =>
                {
                    b.Property<int>("IdModeloAsientoDetalle")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasColumnName("id");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("IdModeloAsientoDetalle"));
                    ...
                    b.Property<int>("IdModeloAsiento")
                        .HasColumnType("integer")
                        .HasColumnName("modelo_asiento_id");
                    ...
                    b.HasKey("IdModeloAsientoDetalle");

                    b.HasIndex("IdCuentaContable");

                    b.HasIndex("IdModeloAsiento");

                    b.ToTable("modelos_asientos_detalles", (string)null);
                });
            ...
            modelBuilder.Entity("api.Models.PeriodoContable", b =>
                {
                    b.Property<int>("IdPeriodoContable")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("IdPeriodoContable"));
            ...
            modelBuilder.Entity("api.Models.PrecioVenta", b =>
                {
                    b.Property<int>("IdPrecioVenta")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasColumnName("Id_Precio_Venta");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("IdPrecioVenta"));
                    ...
                    b.Property<decimal>("PrecioCompraBase")
                        .HasColumnType("decimal(10, 2)")
                        .HasColumnName("Precio_Compra_Base");

                    b.Property<decimal>("PrecioVentaValor")
                        .HasColumnType("decimal(10, 2)")
                    ...
                    b.ToTable("Precios_Ventas", (string)null);
                });
            ...
            modelBuilder.Entity("api.Models.ProcesoContable", b =>
                {
                    b.Property<int>("IdProcesoContable")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("IdProcesoContable"));

                    b.Property<int?>("CantDigitosNivel")
                        .HasColumnType("integer")
                        .HasColumnName("cant_digitos_nivel");

                    b.Property<int?>("CantNiveles")
                        .HasColumnType("integer")
                        .HasColumnName("cant_niveles");
                    ...
                    b.Property<int>("PeriodoAnho")
                        .HasColumnType("integer")
                        .HasColumnName("periodo_anho");

                    b.HasKey("IdProcesoContable");

                    b.ToTable("procesos_contables", (string)null);
                });
            ...
            modelBuilder.Entity("api.Models.Asiento", b =>
                {
                    ...
                    b.HasOne("api.Models.PeriodoContable", "IdPeriodoContableNavigation")
                        .WithMany("Asientos")
                        .HasForeignKey("IdPeriodoContable")
                        .IsRequired()
                        .HasConstraintName("FK_asientos_periodos_contables");

                    b.Navigation("IdModuloNavigation");

                    b.Navigation("IdPeriodoContableNavigation");
                });

            modelBuilder.Entity("api.Models.AsientosDetalle", b =>
                {
                    b.HasOne("api.Models.Asiento", "IdAsientoNavigation")
            ...
            modelBuilder.Entity("api.Models.BalancesDetalle", b =>
                {
                    b.HasOne("api.Models.Balance", "IdBalanceNavigation")
                        .WithMany("BalancesDetalles")
                    ...
                    b.Navigation("IdBalanceNavigation");
            ...
            modelBuilder.Entity("api.Models.CategoriaProveedor", b =>
                {
                    b.HasOne("api.Models.Categoria", "Categoria")
                        .WithMany("CategoriasProveedores")
            ...
            modelBuilder.Entity("api.Models.CuentaContable", b =>
                {
                    ...
                    b.HasOne("api.Models.ProcesoContable", "IdProcesoContableNavigation")
                        .WithMany("CuentasContables")
                        .HasForeignKey("IdProcesoContable")
                        .IsRequired()
            ...
            modelBuilder.Entity("api.Models.ModelosAsientosDetalle", b =>
                {
                    b.HasOne("api.Models.CuentaContable", "IdCuentaContableNavigation")
                        .WithMany("ModelosAsientosDetalles")
                        .HasForeignKey("IdCuentaContable")
                        .IsRequired()
                        .HasConstraintName("FK_modelos_asientos_detalles_cuentas_contables");

                    b.HasOne("api.Models.ModeloAsiento", "IdModeloAsientoNavigation")
                        .WithMany("ModelosAsientosDetalles")
                        .HasForeignKey("IdModeloAsiento")
                        .IsRequired()
            ...
            modelBuilder.Entity("api.Models.CuentaContable", b =>
                {
                    ...
                    b.Navigation("ModelosAsientosDetalles");
                });
