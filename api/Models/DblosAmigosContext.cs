...
public partial class DblosAmigosContext : DbContext
{
    ...
    public virtual DbSet<PedidosCotizacione> PedidosCotizaciones { get; set; }
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        => optionsBuilder.UseSqlServer("Server=(localdb)\\MSSQLLocalDB;Database=DBLosAmigos;Trusted_Connection=True;TrustServerCertificate=True;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<PedidosCotizacione>(entity =>
        {
        ...
        modelBuilder.Entity<Proveedore>(entity =>
        {
            ...
            entity.HasOne(d => d.IdProveedorNavigation).WithOne(p => p.Proveedore)
